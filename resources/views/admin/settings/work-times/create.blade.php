...
@section('title', 'Create Work Time')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Create New Work Time</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.settings.work-times.store') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control @error('late_threshold') is-invalid @enderror"
                                           id="late_threshold" name="late_threshold" value="{{ old('late_threshold', '08:00') }}" required>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Work Time
                            </button>
                        </div>
                    </form>
                </div>
