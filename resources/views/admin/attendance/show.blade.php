            ...
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.attendances.index') }}" class="btn btn-light btn-sm">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const map = L.map('map').setView([
            (schoolLat + attendanceLat) / 2,
            (schoolLng + attendanceLng) / 2
        ], 15);
        ...
        const schoolIcon = L.divIcon({
            html: '<div style="background-color: #e63946; border-radius: 50%; width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; color: white;"><i class="fas fa-school"></i></div>',
            iconSize: [24, 24],
        ...
        const schoolMarker = L.marker([schoolLat, schoolLng], {
            ...
            <small>Jl. Ciliwung No.4, Bandung</small>
        `);
        ...
        const midpoint = {
            lat: (schoolLat + attendanceLat) / 2,
            lng: (schoolLng + attendanceLng) / 2
        };
