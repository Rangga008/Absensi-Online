...
<div>
    Hai <b>{{ ucfirst(session('username')) }}</b>, selamat datang di {{ strtoupper(setting('app_name', 'SMK NEGERI 2 BANDUNG')) }} {{ strtoupper(setting('company_name', 'SMK NEGERI 2 BANDUNG')) }}. <br />
